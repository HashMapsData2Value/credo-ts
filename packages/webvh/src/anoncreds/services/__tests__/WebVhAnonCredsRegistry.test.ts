import type { AgentContext, DidDocumentService, VerificationMethod } from 'hmd2v-credo-core'

import { DidDocument, DidsApi, MultiBaseEncoder, MultiHashEncoder, TypedArrayEncoder } from 'hmd2v-credo-core'
