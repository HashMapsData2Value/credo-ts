...
import type { MessageHandler, MessageHandlerInboundMessage, ProofExchangeRecord } from 'credo-hmd2v-5.17-core'

import { OutboundMessageContext } from 'credo-hmd2v-5.17-core'
