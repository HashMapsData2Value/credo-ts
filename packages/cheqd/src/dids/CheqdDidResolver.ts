...
import type { AgentContext, DidResolutionResult, DidResolver, ParsedDid } from 'credo-hmd2v-5.17-core'

import { DidDocument, CredoError, utils, JsonTransformer } from 'credo-hmd2v-5.17-core'
